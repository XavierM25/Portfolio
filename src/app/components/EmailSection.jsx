...
const EmailSection = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
        .sendForm('service_redsp42', 'template_mtq7mys', form.current, 'Gaieg8JVOAZ8LU7F1')
        .then(
            (result) => {
        ...
        <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
          ...
          <div className='z-10'>
            ...
            <p className='text-[#ADB7BE] mb-4 max-w-md'>
              {" "}
              ¿Estás interesado en contactarte conmigo? Puedes enviarme un mensaje rellenando el formulario o,
                contactarme mediante mis redes sociales. Saludos.
            </p>
          ...
          <div className='mb-6'>
                    ...
                    <div className="mb-6">
                        <label htmlFor="user_name" className='text-white block text-sm mb-2 font-medium'>
                            Asunto
                        </label>
                        <input
                            name='user_name'
